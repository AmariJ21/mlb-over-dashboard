...
// No API key required. Runs server-side on Vercel — users never hit MLB directly.

const MLB_BASE = 'https://statsapi.mlb.com/api/v1'
const LINE = 5.5
const CACHE_SECONDS = 300 // re-fetch every 5 minutes

// Poisson probability: P(X > floor(LINE))
...
export async function GET() {
  try {
    ...
    return Response.json(
      { error: 'Failed to fetch MLB data', detail: err.message },
      { status: 500 }
    )
  }
}
